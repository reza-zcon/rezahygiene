namespace OpsManagement.IntegrationTests.TestUtilities;
...
public static class DockerDatabaseUtilities
{
    ...
    private const string DB_CONTAINER_NAME = "IntegrationTesting_OpsManagement";
    private const string DB_VOLUME_NAME = "IntegrationTesting_OpsManagement";
